...
class CloseCashController extends Controller
{
    ...
    public function import(Request $request)
    {
        ...
        //dump( $closecashlist);
        if (isset($response)) {
            return view('layouts.layout-closecash', ['orgs' => $orgs, 'closecashsumlist' => $response, 'request' => $request, 'closecashlist' => $closecashlist, 'list' => $list]);
        }
    }
    ...
    public function show(Request $request)
    {
        $misDatos = session()->get('misDatos');
        $orgs = $misDatos;
        return view('layouts.layout-closecash', ['orgs' => $orgs, 'request' => $request]);
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($filename == null) {
            //dd($todo);
            $todo->save();
            return view('layouts.layout-closecash', ['orgs' => $orgs]);
        } else {
            //dd($todo);
